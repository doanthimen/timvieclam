...
<head>
  ...
  <link rel="stylesheet" href="source/chitiet/css/bootstrap.min.css">
  <link rel="stylesheet" href="source/chitiet/css/jquery-ui.css">
  <link rel="stylesheet" href="source/chitiet/css/owl.carousel.min.css">
  <link rel="stylesheet" href="source/chitiet/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="css/owl.theme.default.min.css">

  <link rel="stylesheet" href="source/chitiet/css/jquery.fancybox.min.css">

  <link rel="stylesheet" href="source/chitiet/css/bootstrap-datepicker.css">

  <link rel="stylesheet" href="source/chitiet/fonts/flaticon/font/flaticon.css">

  <link rel="stylesheet" href="css/aos.css">
  <link href="source/chitiet/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">

  <link rel="stylesheet" href="source/chitiet/css/style.css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <script src="source/chitiet/js/jquery-3.3.1.min.js"></script>
    <script src="source/chitiet/js/jquery-migrate-3.0.1.min.js"></script>
    <script src="source/chitiet/js/jquery-ui.js"></script>
    <script src="source/chitiet/js/popper.min.js"></script>
    <script src="source/chitiet/js/bootstrap.min.js"></script>
    <script src="source/chitiet/js/owl.carousel.min.js"></script>
    <script src="source/chitiet/js/jquery.stellar.min.js"></script>
    <script src="source/chitiet/js/jquery.countdown.min.js"></script>
    <script src="source/chitiet/js/bootstrap-datepicker.min.js"></script>
    <script src="source/chitiet/js/jquery.easing.1.3.js"></script>
    <script src="source/chitiet/js/aos.js"></script>
    <script src="source/chitiet/js/jquery.fancybox.min.js"></script>
    <script src="source/chitiet/js/jquery.sticky.js"></script>
    <script src="source/chitiet/js/jquery.mb.YTPlayer.min.js"></script>




    <script src="source/chitiet/js/main.js"></script>
