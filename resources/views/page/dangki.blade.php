...
<html>
    <head>
        <meta charset="utf-8">
        <title>Người tìm việc đăng kí</title>
    ...
    <body>
            ...
            <div class="inner">
                <div class="image-holder">
                    <img src="source/dangky/images/1234.jpg" align="top" height="600" width="600" alt="">
                </div>
                <form action="{{route('signin')}}" method="post" class="beta-form-checkout">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        @endif
                      <h3 style="color: pink; font-family: sans-serif; font-weight: bold">ĐĂNG KÝ TÀI KHOẢN NGƯỜI TÌM VIỆC</h4>
                        ...
                        <center>
                         ...
                         @endforeach</h4>
                          ...
                          <h4 style="color: blue; font-family: sans-serif; font-weight: bold">@if (Session::has('dang ky'))
